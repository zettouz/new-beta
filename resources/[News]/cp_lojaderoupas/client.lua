...
Tunnel.bindInterface("cp_lojaderoupas", vRPrp)
Proxy.addInterface("cp_lojaderoupas", vRPrp)

emP = Tunnel.getInterface("cp_lojaderoupas")
...
local lojaderoupa = {
    ...
    { name = "Exclusiva Modas", id = 73, color = 13, x = 1781.73, y = 107.58, z = 172.09, provador = {x = 1781.73, y = 107.58, z = 172.09, heading = 13.57}}, --favela
