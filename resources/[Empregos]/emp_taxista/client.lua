...
local blips = nil
local selecionado = 0
local emservico = false --896.84,-177.42,74.71
local CoordenadaX = 896.84
local CoordenadaY = -177.42
			...
			if distance <= 3 then
				...
				if distance <= 1.2 then
					...
					if IsControlJustPressed(0,38) then
						...
						TriggerEvent("Notify","bom","<b>Downtown:</b> Você está contratado(a)!",4000)
						TriggerEvent("Notify","bom","<b>Downtown:</b> Trate bem os passageiros!",5000)
					end
				end
			end
		end
