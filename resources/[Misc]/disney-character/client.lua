...
AddEventHandler("disney-character:normalSpawn",function(firstspawn)
	if firstspawn then
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	SetEntityCoordsNoOffset(PlayerPedId(), 1832.38, 2607.83, 45.59,true,true,true)
	SetEntityHeading(PlayerPedId(),f(269.25))
	...
	TriggerServerEvent("disney-character:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
