...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "diretoria" then
		TriggerServerEvent("diretoria")
	
	elseif data == "medico" then
		TriggerServerEvent("medico")

	elseif data == "medico2" then
		TriggerServerEvent("medico2")

	elseif data == "medico3" then
		TriggerServerEvent("medico3")

	elseif data == "farmaceutico" then
		TriggerServerEvent("farmaceutico")
