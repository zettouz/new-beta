...
-----------------------------------------------------------------------------------------------------------------------------------------
local valores = {
	{ item = "mascara", quantidade = 1, compra = 1000 },
	{ item = "mochila", quantidade = 1, compra = 10000 },
	{ item = "oculos", quantidade = 1, compra = 1000 },
	{ item = "roupas", quantidade = 1, compra = 15000 },
	{ item = "chapeu", quantidade = 1, compra = 1000 },
	{ item = "sapatos", quantidade = 1, compra = 2500 },
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ COMPRAR ]----------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
