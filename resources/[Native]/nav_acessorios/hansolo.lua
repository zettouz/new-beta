...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	elseif data == "comprar-roupas" then
		TriggerServerEvent("acessorios-comprar","roupas")
		
	elseif data == "comprar-chapeu" then
		TriggerServerEvent("acessorios-comprar","chapeu")
	
	elseif data == "comprar-sapatos" then
		TriggerServerEvent("acessorios-comprar","sapatos")
