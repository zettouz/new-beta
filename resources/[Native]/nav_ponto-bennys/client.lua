...
Bennys = Tunnel.getInterface("nav_ponto-bennys")
-----------------------------------------------------------------------------------------------------------------------------------------
--[ FUNCTION ]---------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "entrar-servico-bennys" then
		TriggerServerEvent("entrar-servico-bennys")
	
	elseif data == "sair-servico-bennys" then
		TriggerServerEvent("sair-servico-bennys")
