...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "comprar-sanduiche" then
		TriggerServerEvent("comida-comprar","sanduiche")

	elseif data == "comprar-rosquinha" then
		TriggerServerEvent("comida-comprar","rosquinha")

	elseif data == "comprar-hotdog" then
		TriggerServerEvent("comida-comprar","hotdog")

	elseif data == "comprar-xburguer" then
		TriggerServerEvent("comida-comprar","xburguer")

	elseif data == "comprar-chips" then
		TriggerServerEvent("comida-comprar","chips")

	elseif data == "comprar-batataf" then
		TriggerServerEvent("comida-comprar","batataf")

	elseif data == "comprar-pizza" then
		TriggerServerEvent("comida-comprar","pizza")

	elseif data == "comprar-taco" then
		TriggerServerEvent("comida-comprar","taco")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local lojas = {
	{ ['x'] = 320.09, ['y'] = -599.63, ['z'] = 43.3 },
	{ ['x'] = -1333.82, ['y'] = -1282.76, ['z'] = 4.84 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ MENU ]-------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
