...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	if data == "Entrar" then
		...
		SetTimeout(1400,function()
			SetEntityCoords(PlayerPedId(),133.17,-1293.7,29.27-0.50,37.08)
			SetEntityHeading(ped,115.09)
	...
	elseif data == "Sair" then
		...
		menuactive = false
		SetTimeout(1400,function()
			SetEntityCoords(PlayerPedId(),132.51,-1287.42,29.28)
			SetEntityHeading(ped,22.91)
			TriggerEvent("vrp_sound:source",'elevator-bell',0.5)
			Citizen.Wait(750)
			DoScreenFadeIn(1000)
		end)
...
-----------------------------------------------------------------------------------------------------------------------------------------
local elevadores = {
	{ ['x'] = 133.17, ['y'] = -1293.7, ['z'] = 29.27 }, -- Baixo;
	{ ['x'] = 132.51, ['y'] = -1287.42, ['z'] = 29.28 }, -- Cima
}
