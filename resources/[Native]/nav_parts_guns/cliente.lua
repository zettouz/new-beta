...
RegisterNUICallback("ButtonClick",function(data,cb)
    ...
    elseif data == "comprar-corpo-aks74u" then
		TriggerServerEvent("departamento-comprar","corpo-aks74u")
	elseif data == "comprar-corpo-uzi" then
		TriggerServerEvent("departamento-comprar","corpo-uzi")
	elseif data == "comprar-corpo-fiveseven" then
		TriggerServerEvent("departamento-comprar","corpo-fiveseven")
