...
Perm = {}
Tunnel.bindInterface("nav_ingre-meta",Perm)
-----------------------------------------------------------------------------------------------------------------------------------------
--[ ARRAY ]------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
local valores = {
	{ item = "nitrato-amonia", quantidade = 1, compra = 30 },
	{ item = "hidroxido-sodio", quantidade = 1, compra = 30 },
	{ item = "pseudoefedrina", quantidade = 1, compra = 30 },
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ COMPRAR ]----------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
