...
local valores = {
	...
	{ item = "corvina", venda = 210 },
	{ item = "salmao", venda = 185 },
	{ item = "pacu", venda = 120 },
	{ item = "pintado", venda = 135 },
	{ item = "pirarucu", venda = 140 },
	{ item = "tilapia", venda = 80 },
	{ item = "tucunare", venda = 170 },
	{ item = "lambari", venda = 340 },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VENDER
-----------------------------------------------------------------------------------------------------------------------------------------
