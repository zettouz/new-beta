...
Citizen.CreateThread(function()
	...
	while true do
		Citizen.Wait(1)
		local distance = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),3807.90,4478.58,6.36,true)
		if distance <= 3 then
			DrawMarker(21,3807.90,4478.58,6.36-0.6,0,0,0,0.0,0,0,0.5,0.5,0.4,255,0,0,50,0,0,0,1)
