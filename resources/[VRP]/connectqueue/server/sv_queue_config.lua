...
Config.Language = {
    ...
    pos = "\xF0\x9F\x90\x8Cvocê é o nº %d/%d da fila \xF0\x9F\x95\x9C%s",
    ...
    steam = "\xE2\x9D\x97 [Queue] STEAM ERROR: Você precisa estar com a STEAM aberta SEMPRE para jogar."
}