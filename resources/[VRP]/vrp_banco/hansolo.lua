...
local locais = {
	...
	{ ['id'] = 15, ['x'] = 1172.5, ['y'] = 2702.5, ['z'] = 38.17, ['h'] = 359.88 }
}
...
local atms = {
	...
	{name='ATM', id=277, x=1172.5, y=2702.5, z=38.17}
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ CALCULAR TEMPO ]---------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterNetEvent('balance:back225282828')
AddEventHandler('balance:back225282828', function(balance)
