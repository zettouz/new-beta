...
AddEventHandler('fuel:startFuelUpTick',function(pumpObject,ped,vehicle)
	...
	if pumpObject then
		TriggerServerEvent('vrp_legacyfuel:pagamento5687987978978',parseInt(currentCost),false,VehToNet(vehicle),GetVehicleFuelLevel(vehicle),currentFuel2)
	end

	currentCost = 0.0
end)

RegisterNetEvent("vrp_legacyfuel:insuficiente5687987978978")
AddEventHandler("vrp_legacyfuel:insuficiente5687987978978",function(index,fuel)
...
RegisterNetEvent('vrp_legacyfuel:galao5687987978978')
AddEventHandler('vrp_legacyfuel:galao5687987978978',function()
		...
		if not isFueling and ((isNearPump and GetEntityHealth(isNearPump) > 0) or (GetSelectedPedWeapon(ped) == 883325847 and not isNearPump)) then
			if IsPedInAnyVehicle(ped) and GetPedInVehicleSeat(GetVehiclePedIsIn(ped),-1) == ped then
				...
				elseif isNearPump then
					...
					if IsControlJustReleased(0,38) then
						TriggerServerEvent('vrp_legacyfuel:pagamento5687987978978',parseInt(300),true)
					end
				else
					Citizen.Wait(250)
				end
