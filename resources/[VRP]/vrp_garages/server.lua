...
local webhookvehs = "SEUWEBHOOK"
local webhookdesmanche = "SEUWEBHOOK"
...
local garages = {
	...
	[16] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[17] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[18] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[19] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[20] = { ['name'] = "PoliciaB", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[21] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[22] = { ['name'] = "PoliciaA", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[23] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "dmla.permissao" },
	[24] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "dmla.permissao" },
	[25] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "dmla.permissao" },
	[26] = { ['name'] = "ParamedicoH", ['payment'] = false, ['perm'] = "dmla.permissao" },
	...
	[31] = { ['name'] = "Carteiros", ['payment'] = false, ['perm'] = "livre" },
	...
	[42] = { ['name'] = "Cosanostra", ['payment'] = true, ['perm'] = "cosanostra.permissao" },
	--[43] = { ['name'] = "FuriousBarcos", ['payment'] = true, ['perm'] = "furious.permissao" },
	[44] = { ['name'] = "Motoclub", ['payment'] = true, ['perm'] = "mc.permissao" },
	[45] = { ['name'] = "Motoclub", ['payment'] = true, ['perm'] = "mc.permissao" },
	[46] = { ['name'] = "Vagos", ['payment'] = true, ['perm'] = "vagos.permissao" },
	[47] = { ['name'] = "Ballas", ['payment'] = true, ['perm'] = "ballas.permissao" },
	[48] = { ['name'] = "Families", ['payment'] = true, ['perm'] = "families.permissao" },
	[49] = { ['name'] = "Skulls", ['payment'] = true, ['perm'] = "skulls.permissao" },
	...
	[61] = { ['name'] = "Bike", ['payment'] = true, ['perm'] = "livre" },
	[62] = { ['name'] = "Cargas", ['payment'] = true, ['perm'] = "livre" },
	--[63] = { ['name'] = "Surf", ['payment'] = true, ['perm'] = "livre" },
	[64] = { ['name'] = "Mecanico", ['payment'] = false, ['perm'] = "mecanico.permissao" },
	--[65] = { ['name'] = "Caminhoneiro", ['payment'] = false, ['perm'] = "livre" },
	[66] = { ['name'] = "Cargas2", ['payment'] = true, ['perm'] = "livre" },
	[67] = { ['name'] = "Bicicletario", ['payment'] = true, ['perm'] = "livre" },
	[69] = { ['name'] = "CSC", ['payment'] = true, ['perm'] = "admin.permissao" },
	--[70] = { ['name'] = "Taxista", ['payment'] = false, ['perm'] = "livre" },
	[71] = { ['name'] = "Motorista", ['payment'] = false, ['perm'] = "livre" },
	--[72] = { ['name'] = "Lixeiro", ['payment'] = false, ['perm'] = "livre" },
	--[73] = { ['name'] = "Leiteiro", ['payment'] = false, ['perm'] = "livre" },
	[74] = { ['name'] = "PoliciaHnorte", ['payment'] = false, ['perm'] = "bcso.permissao" },
	[75] = { ['name'] = "PoliciaBnorte", ['payment'] = false, ['perm'] = "bcso.permissao" },
	--[76] = { ['name'] = "Lenhador", ['payment'] = false, ['perm'] = "livre" },
	[77] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[78] = { ['name'] = "Harpias", ['payment'] = false, ['perm'] = "harpias.permissao" },
	[79] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	--[80] = { ['name'] = "HellsAngels", ['payment'] = false, ['perm'] = "hellsangels.permissao" },
	[81] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[82] = { ['name'] = "Merry", ['payment'] = true, ['perm'] = "merry.permissao" },
	[83] = { ['name'] = "Merry2", ['payment'] = true, ['perm'] = "merry.permissao" },
	[84] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[85] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[86] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[87] = { ['name'] = "Bahamas", ['payment'] = true, ['perm'] = "boate.permissao" },
	[89] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[90] = { ['name'] = "Leilao", ['payment'] = true, ['perm'] = "leilao.permissao" },
	[91] = { ['name'] = "Mecanico", ['payment'] = false, ['perm'] = "mecanico.permissao" },
	[92] = { ['name'] = "Serpentes", ['payment'] = false, ['perm'] = "serpentes.permissao" },
	[93] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[94] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[95] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[96] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[97] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[98] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[99] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[100] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[101] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[102] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[103] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[104] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[105] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[106] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[107] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[108] = { ['name'] = "Bratva", ['payment'] = false, ['perm'] = "bratva.permissao" },
	[109] = { ['name'] = "Boate2", ['payment'] = false, ['perm'] = "boate.permissao" },
	[110] = { ['name'] = "MidnightClub", ['payment'] = false, ['perm'] = "midnightclub.permissao" },
	[111] = { ['name'] = "Dolls", ['payment'] = false, ['perm'] = "dolls.permissao" },
	[112] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[113] = { ['name'] = "DriftKing2", ['payment'] = false, ['perm'] = "driftking.permissao" },
-----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------FORTHILLS-----------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	[145] = { ['name'] = "FH01", ['payment'] = false, ['public'] = false },
	[148] = { ['name'] = "FH04", ['payment'] = false, ['public'] = false },
	[149] = { ['name'] = "FH10", ['payment'] = false, ['public'] = false },
...
-------------------------------------------------------------FAVELA/BARRAGEM------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------
	[508] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
-----------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------Zancudo Avenue--------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	[509] = { ['name'] = "ZA01", ['payment'] = false, ['public'] = false },
-----------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------MANSAO------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[609] = { ['name'] = "Piloto", ['payment'] = false, ['perm'] = "piloto.permissao" },	
	[610] = { ['name'] = "Fotos", ['payment'] = false, ['perm'] = "admin.permissao" },
	[611] = { ['name'] = "FZ02", ['payment'] = false, ['public'] = false },
-----------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------NOVOS-------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	[612] = { ['name'] = "Garagem", ['payment'] = false, ['public'] = true },
	[613] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "dmla.permissao" },
	[614] = { ['name'] = "Sherrif", ['payment'] = false, ['perm'] = "dmla.permissao" },
	[615] = { ['name'] = "FZ03", ['payment'] = false, ['public'] = false },
	[616] = { ['name'] = "FZ04", ['payment'] = false, ['public'] = false },
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ GARAGEMS ]---------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
			...
			if #address > 0 then
					...
					if v.home == work then
						for k2,v2 in pairs(vehicle) do
							if parseInt(os.time()) <= parseInt(vehicle[k2].time+24*60*60) then
								status = "<span class=\"red\">$"..vRP.format(parseInt(vRP.vehiclePrice(vehicle[k2].vehicle)*0.030)).."</span>"
							elseif vehicle[k2].detido == 1 then
								status = "<span class=\"orange\">$"..vRP.format(parseInt(vRP.vehiclePrice(vehicle[k2].vehicle)*0.030)).."</span>"
							else
						...
						for k2,v2 in pairs(vehicle) do
							...
							elseif vehicle[k2].detido == 1 then
								...
								status = "<span class=\"green\">$"..vRP.format(parseInt(vRP.vehiclePrice(vehicle[k2].vehicle)*0.030)).."</span>"
							end
				...
				for k,v in pairs(vehicle) do
					if parseInt(os.time()) <= parseInt(vehicle[k].time+24*60*60) then
						status = "<span class=\"red\">$"..vRP.format(parseInt(vRP.vehiclePrice(vehicle[k].vehicle)*0.030)).."</span>"
					elseif vehicle[k].detido == 1 then
						status = "<span class=\"orange\">$"..vRP.format(parseInt(vRP.vehiclePrice(vehicle[k].vehicle)*0.030)).."</span>"
					else
						status = "<span class=\"green\">$"..vRP.format(parseInt(vRP.vehiclePrice(vehicle[k].vehicle)*0.030)).."</span>"
					end
			...
			if not vCLIENT.returnVehicle(source,name) then
				...
				if vehicle[1] ~= nil then
					if parseInt(os.time()) <= parseInt(vehicle[1].time+24*60*60) then
						local ok = vRP.request(source,"Veículo na retenção, deseja acionar o seguro pagando <b>$"..vRP.format(parseInt(vRP.vehiclePrice(name)*0.030)).."</b> dólares ?",60)
						if ok then
							if vRP.tryFullPayment(user_id,parseInt(vRP.vehiclePrice(name)*0.030)) then
...
--[ VEHPRICE ]---------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterServerEvent("desmancheVehicles5454564645666")
AddEventHandler("desmancheVehicles5454564645666",function()
	local source = source
	local user_id = vRP.getUserId(source)
	if user_id then
		...
		if vehicle and placa then
			...
			if puser_id then
				...
				vRP.giveInventoryItem(user_id,"dinheiro-sujo",parseInt(vRP.vehiclePrice(vname)*0.3))
				vCLIENT.deleteVehicle(source,vehicle)
				local identity = vRP.getUserIdentity(user_id)
...
RegisterCommand('dv',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"mindmaster.permissao") or vRP.hasPermission(user_id,"suporte.permissao") or vRP.hasPermission(user_id,"administrador.permissao") or vRP.hasPermission(user_id,"moderador.permissao") or vRP.hasPermission(user_id,"mecanico.permissao") or vRP.hasPermission(user_id,"bcso.permissao") or vRP.hasPermission(user_id,"dmla.permissao") then
