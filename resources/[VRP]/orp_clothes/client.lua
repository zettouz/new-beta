...
Tunnel.bindInterface("orp_clothes", vRPrp)
Proxy.addInterface("orp_clothes", vRPrp)

local lojaderoupa = {
    {x = 75.40, y =  -1392.92, z = 29.37, provador = {x = 75.40, y =  -1392.92, z = 29.37, heading = 0.0}},
    {x = -709.40, y =  -153.66, z =  37.41, provador = {x =  -709.40, y =  -153.66, z =  37.41, heading = 0.0}},
    {x =  -163.20, y = -302.03, z = 39.73, provador = {x = -163.20, y = -302.03, z = 39.73, heading = 0.0}},
    {x = 425.58, y =  -806.23, z =  29.49, provador = {x = 425.58, y =  -806.23, z =  29.49, heading = 0.0}},
    {x = -822.34, y = -1073.49, z = 11.32, provador = {x = -822.34, y = -1073.49, z = 11.32, heading = 0.0}},
    {x =  -1193.81, y =  -768.49, z = 17.31, provador = {x =  -1193.81, y =  -768.49, z = 17.31, heading = 0.0}},
    ...
    {x =  1196.8, y = 2709.83, z = 38.23, provador = {x =  1196.8, y = 2709.83, z = 38.23, heading = 0.0}},
    {x = -3170.18, y = 1044.54, z = 20.86, provador = {x = -3170.18, y = 1044.54, z = 20.86, heading = 0.0}},
    {x = -1101.46, y = 2710.57, z = 19.10, provador = {x = -1101.46, y = 2710.57, z = 19.10, heading = 0.0}},
    {x =  -1098.15, y =  -831.61, z = 14.29, provador = {x =  -1098.15, y =  -831.61, z = 14.29, heading = 0.0}},
    {x = 268.78, y =  -1363.42, z = 24.54, provador = {x = 268.78, y =  -1363.42, z = 24.54, heading = 0.0}},
    {x =  -574.13, y = 287.42, z = 79.18, provador = {x =  -574.13, y = 287.42, z = 79.18, heading = 0.0}},
    {x =  105.28, y = -1303.1, z = 28.77, provador = {x =  105.28, y = -1303.1, z = 28.77, heading = 0.0}},
    {x = 242.39, y = -347.57, z = -118.79, provador = {x = 242.39, y = -347.57, z = -118.79, heading = 0.0}},
    {x = 150.17, y = -767.93, z = 50.14, provador = {x = 150.17, y = -767.93, z = 50.14, heading = 0.0}},
    ...
    while true do
        ...
        for k, v in pairs(lojaderoupa) do
            ...
            if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, lojaderoupa[k].x, lojaderoupa[k].y, lojaderoupa[k].z, true ) <= 5 and not in_loja then
                DrawText3D(lojaderoupa[k].x, lojaderoupa[k].y, lojaderoupa[k].z-0.1, "Pressione [~b~E~w~] para acessar a ~b~LOJA DE ROUPAS~w~")
                DrawMarker(23, lojaderoupa[k].x, lojaderoupa[k].y, lojaderoupa[k].z-0.99, 0, 0, 0, 0, 0, 0, 0.7, 0.7, 0.5, 101, 212, 255, 150, 0, 0, 0, 0)
            end
