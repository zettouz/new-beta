const mdtApp = new Vue({
    ...
    methods: {
        ...
        OpenOffenderDetails(id) {
            const offender = this.offender_results.results.find((offender) => offender.user_id === id)
            if(!offender) return ;
        ...
        AddCharge(id) {
            const offense = this.offenses.find((o) => id == o.id )

            var offense_name = offense.label
            ...
            this.report_new.recommended_fine = this.report_new.recommended_fine + offense.amount

            if (offense.jailtime) {
                this.report_new.recommended_sentence = this.report_new.recommended_sentence + offense.jailtime
            }
