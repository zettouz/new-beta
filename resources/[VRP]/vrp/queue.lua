...
Config.Language = {
	joining = "[NOME] Entrando...",
	connecting = "[NOME] Conectando...",
	err = "[NOME] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[NOME] Você foi desconectado por demorar demais na fila.",
	pos = "[NOME] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[NOME] Não foi possível adiciona-lo na fila.",
    wlonly = "[NOME] Você não está aprovado na whitelist.",
	banned = "[NOME] Seu passaporte foi revogado na cidade.",
	steam = "[NOME] Você precisa estar com a Steam aberta para conectar."
}
